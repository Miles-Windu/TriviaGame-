...
// True or false values added to the DOM after each question 
var choices = "<form><input type= 'radio' value='true' name='true/false'> True <input type='radio' value='false' name='true/false'>False </form>";
